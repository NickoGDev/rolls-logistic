...
<head>
    ...
    <!-- CSS LINK STYLE COMPONENTS -->
    <link rel="stylesheet" href="STYLES/STYLES-COMPONENTS/card-grids4.css">
    <link rel="stylesheet" href="STYLES/STYLES-COMPONENTS/equal-horizontalE.css">
    <link rel="stylesheet" href="STYLES/STYLES-COMPONENTS/bread-crumbs.css">
    <meta charset="UTF-8">
    ...
    <div class="service-body-Container">
        <div class="service-body-section">
            <div class="transit-services-container">
                ...
                <!-- equal-horizontalE -->
                <div class="equal-horizontalE">
                    <div class="equal-horizontalE-left">
                        <div class="equal-horizontal-paragraph">
                            <div class="equal-horizontalE-header">
                                Voyage, your shipment with Rolls
                            </div>
                            <div class="equal-horizontalE-textS">
                                Rolls is for small and medium businesses looking for simple and reliable global transportation solutions.
                                You don’t need to be a shipping expert to get started with Rolls.
                            </div>
                            <ul class="equal-horizontalE-listSC">
                                <li>An intuitive platform to manage all your shipments and tasks in one place.</li>
                                <li>Instant and transparent prices so you can plan and budget with peace of mind.</li>
                                <li>Book shipments in just a few steps and easily add extra services like inland transportation and customs services.</li>
                            </ul>
                        </div>
                        <div class="equal-horizontal-buttonC">
                            <a href="">Learn more</a>
                        </div>
                    </div>
                    <div class="equal-horizontalE-right">
                        <img src="IMAGES/GENERAL/PORTAL-PAGES/SERVICES/bussiness-team.jpg" alt="">
                    </div>
                </div>
                <div class="spacer3"></div>
                <!-- transit-offering-container -->
                <div class="transit-offering-container" id="transit-offering-container-servicesPage">
                    <div class="transit-offering-contents">
                        <img src="IMAGES/GENERAL/PORTAL-PAGES/SERVICES/cross-border.jpg" alt="">
                        <div class="transit-offering-text">
                            <div class="transit-offering-text">
                                <label class="transit-offering-textH">
                                    Cross border
                    ...
                    <div class="transit-offering-contents">
                        <img src="IMAGES/GENERAL/PORTAL-PAGES/SERVICES/container-protect.webp" alt="">
                        <div class="transit-offering-text">
                            <label class="transit-offering-textH">
                                Container protect
                            </label>
                            <label class="transit-offering-textS">
                                Seamlessly protect your cargo’s journey from container damage settlements without any hassles.
                            </label>
                        </div>
                    </div>
                    <div class="transit-offering-contents">
                        <img src="IMAGES/GENERAL/PORTAL-PAGES/SERVICES/value-protect.jpg" alt="">
                        <div class="transit-offering-text">
                            <label class="transit-offering-textH">
                                Value protect
                            </label>
                            <label class="transit-offering-textS">
                                A simple and smart way to protect your cargo from logistics-related risks during its journey.
                            </label>
                        </div>
                    </div>
                    <div class="transit-offering-contents">
                        <img src="IMAGES/GENERAL/PORTAL-PAGES/SERVICES/insurance.jpg" alt="">
                        <div class="transit-offering-text">
                            <label class="transit-offering-textH">
                                Rolls cargo insurance
                            </label>
                            <label class="transit-offering-textS">
                                Take no chances. Get comprehensive cover for your cargo through Rolls Cargo Insurance, provided by Zurich Insurance.
                            </label>
                        </div>
                    </div>
                </div>
